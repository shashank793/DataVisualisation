...
from app import app
from layouts import layout_conf_fail_category,layout_diag_fail_category,noPage
#, layout_ga_category, layout_paid_search,  layout_display, layout_publishing, layout_metasearch
import callbacks
...
<html>
    <head>
        {%metas%}
        <title>Jobs Performace Reporting</title>
        {%favicon%}
        {%css%}
    </head>
    <body>
        ...
        <div>Jobs Performance Reporting</div>
    </body>
</html>
'''
...
def display_page(pathname):
    if pathname == '/conf-report' or pathname == '/report/conf-failure/':
        return layout_conf_fail_category
    if pathname == '/diag-report' or pathname == '/report/diag-failure/':
        return layout_diag_fail_category
